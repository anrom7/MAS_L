...
public class ComplexBehaviourAgent extends Agent {
  ...
  protected void setup() {
    ...
    myBehaviour2_2.addSubBehaviour(new SingleStepBehaviour(this, "2.2.a"));
    myBehaviour2_2.addSubBehaviour(new SingleStepBehaviour(this, "2.2.b"));
    myBehaviour2_2.addSubBehaviour(new SingleStepBehaviour(this, "2.2.c"));
    myBehaviour2_2.addSubBehaviour(new SingleStepBehaviour(this, "2.2.d"));
