...
/**
  ...
  public static final String PERSON_COMPETENCE = "competence";
  ...
  */
  ...
  private EmploymentOntology() {
    ...
    try {
	    ...
	    add(competenceSchema, DefaultCompetence.class);
    	...
    	cs.add(PERSON_COMPETENCE, competenceSchema, ObjectSchema.OPTIONAL);
