...
import lab3.competenceontology.impl.DefaultCompetence;
import lab3.employment.Address;
import lab3.employment.Company;
import lab3.employment.EmploymentOntology;
import lab3.employment.Engage;
import lab3.employment.Person;
import lab3.employment.WorksFor;
	...
	class HandleEngagementBehaviour extends SequentialBehaviour {
		...
		public void onStart(){
			...
			try{
				...
				System.out.print("  Person competence (y/n) ---> ");
				
				String value = buff.readLine();
				if (value.startsWith("y")) {
					p.setCompetence(new DefaultCompetence());
				}
