...
import jobseekerontology.ontology.impl.DefaultVacancy;
...
public class Person implements Predicate {
	...
	private DefaultVacancy vacancy;
	...
	public DefaultVacancy getVacancy() {
		return vacancy;
	}
	public void setVacancy(DefaultVacancy vacancy) {
	...
	public boolean equals(Person p){
		...
		if (_address != null && p.getAddress() != null) // Address is an optional field
			if (!_address.equals(p.getAddress()))
				return false;
		if (!vacancy.equals(p.getVacancy()))
			return false;
		return true;
	}
}