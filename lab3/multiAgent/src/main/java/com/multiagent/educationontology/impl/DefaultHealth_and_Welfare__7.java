...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Health_and_Welfare__7
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:59
*/
public class DefaultHealth_and_Welfare__7 implements Health_and_Welfare__7 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultHealth_and_Welfare__7() {
    this._internalInstanceName = "";
  }

  public DefaultHealth_and_Welfare__7(String instance_name) {
