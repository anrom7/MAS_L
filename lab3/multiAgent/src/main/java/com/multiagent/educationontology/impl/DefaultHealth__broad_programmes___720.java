...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Health__broad_programmes___720
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:58
*/
public class DefaultHealth__broad_programmes___720 implements Health__broad_programmes___720 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultHealth__broad_programmes___720() {
    this._internalInstanceName = "";
  }

  public DefaultHealth__broad_programmes___720(String instance_name) {
