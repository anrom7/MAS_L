...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Services__8
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:57
*/
public class DefaultServices__8 implements Services__8 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultServices__8() {
    this._internalInstanceName = "";
  }

  public DefaultServices__8(String instance_name) {
