...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Food_processing__541
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:59
*/
public class DefaultFood_processing__541 implements Food_processing__541 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultFood_processing__541() {
    this._internalInstanceName = "";
  }

  public DefaultFood_processing__541(String instance_name) {
