...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Education_science__142
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:57
*/
public class DefaultEducation_science__142 implements Education_science__142 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultEducation_science__142() {
    this._internalInstanceName = "";
  }

  public DefaultEducation_science__142(String instance_name) {
