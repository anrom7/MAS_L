...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Agriculture_and_Veterinary__6
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:59
*/
public class DefaultAgriculture_and_Veterinary__6 implements Agriculture_and_Veterinary__6 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultAgriculture_and_Veterinary__6() {
    this._internalInstanceName = "";
  }

  public DefaultAgriculture_and_Veterinary__6(String instance_name) {
