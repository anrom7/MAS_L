...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Computer_science__481
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:58
*/
public class DefaultComputer_science__481 implements Computer_science__481 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultComputer_science__481() {
    this._internalInstanceName = "";
  }

  public DefaultComputer_science__481(String instance_name) {
