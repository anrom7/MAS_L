...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Education_Ontology#Domestic_services__814
* @author OntologyBeanGenerator v4.1
* @version 2015/06/9, 01:39:58
*/
public class DefaultDomestic_services__814 implements Domestic_services__814 {

  private static final long serialVersionUID = 8382767021263464332L;

  private String _internalInstanceName = null;

  public DefaultDomestic_services__814() {
    this._internalInstanceName = "";
  }

  public DefaultDomestic_services__814(String instance_name) {
