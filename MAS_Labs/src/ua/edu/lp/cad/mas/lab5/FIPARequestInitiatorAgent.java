...
public class FIPARequestInitiatorAgent extends Agent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -942375817766087293L;
	...
	protected void setup() {
		...
		if (args != null && args.length > 0) {
			...
			addBehaviour(new AchieveREInitiator(this, msg) {
				 ...
				 * 
				 */
				private static final long serialVersionUID = 5162586806539998891L;
				...
				protected void handleAllResultNotifications(Vector notifications) {
					if (notifications.size() < nResponders) {
						...
						System.out.println("Timeout expired: missing "
								+ (nResponders - notifications.size())
								+ " responses");
					}
				}
			});
