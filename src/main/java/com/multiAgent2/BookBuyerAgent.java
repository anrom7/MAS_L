			...
			case 1:
				...
				if (reply != null) {
					...
					if (reply.getPerformative() == ACLMessage.PROPOSE) {
						...
						if ((bestSeller == null || price < bestPrice)&&(price<=targetBookPrice)) {
	...
	public void updateRecord(final String title, final int price) {
		...
		addBehaviour(new OneShotBehaviour() {
			...
			public void action() {
				...
				System.out.println("Target book is " + targetBookTitle + ",Limit price is "+ targetBookPrice);
			}
		} );
