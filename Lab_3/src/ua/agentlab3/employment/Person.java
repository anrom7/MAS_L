...
public class Person implements Predicate {
	...
	private DefaultArtistic_Skill artistic_skill;
	...
	public DefaultArtistic_Skill getArtistic_Skill() {
		return artistic_skill;
	}

	public void setArtistic_Skill(DefaultArtistic_Skill artistic_skill) {
		this.artistic_skill = artistic_skill;
	}
}