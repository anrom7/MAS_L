...
import java.util.*;
import ua.agentlab3.skillontology.impl.DefaultArtistic_Skill;
...
public class EmploymentOntology extends Ontology {
  ...
  public static final String PERSON_SKILL = "Artistic_skill";
  ...
  public static final String ARTISTIC_SCILL = "Artistic_skill";
  ...
  */
  ...
  private EmploymentOntology() {
    ...
    try {
		...
		ConceptSchema skillSchema = new ConceptSchema(ARTISTIC_SCILL);
	    add(skillSchema, DefaultArtistic_Skill.class);
    	...
    	cs.add(PERSON_SKILL, skillSchema, ObjectSchema.OPTIONAL);
