...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Skill_Ontology#Artistic_Skill
* @author OntologyBeanGenerator v4.1
* @version 2015/06/10, 23:36:36
*/
public class DefaultArtistic_Skill implements Artistic_Skill {

  private static final long serialVersionUID = -1750159446835811867L;

  private String _internalInstanceName = null;

  public DefaultArtistic_Skill() {
    this._internalInstanceName = "";
  }

  public DefaultArtistic_Skill(String instance_name) {
