...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Skill_Ontology#Accounting_Application
* @author OntologyBeanGenerator v4.1
* @version 2015/06/10, 23:36:36
*/
public class DefaultAccounting_Application implements Accounting_Application {

  private static final long serialVersionUID = -1750159446835811867L;

  private String _internalInstanceName = null;

  public DefaultAccounting_Application() {
    this._internalInstanceName = "";
  }

  public DefaultAccounting_Application(String instance_name) {
