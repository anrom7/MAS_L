...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Skill_Ontology#Apple_Operating_System
* @author OntologyBeanGenerator v4.1
* @version 2015/06/10, 23:36:36
*/
public class DefaultApple_Operating_System implements Apple_Operating_System {

  private static final long serialVersionUID = -1750159446835811867L;

  private String _internalInstanceName = null;

  public DefaultApple_Operating_System() {
    this._internalInstanceName = "";
  }

  public DefaultApple_Operating_System(String instance_name) {
