...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Skill_Ontology#A__Certificate
* @author OntologyBeanGenerator v4.1
* @version 2015/06/10, 23:36:36
*/
public class DefaultA__Certificate implements A__Certificate {

  private static final long serialVersionUID = -1750159446835811867L;

  private String _internalInstanceName = null;

  public DefaultA__Certificate() {
    this._internalInstanceName = "";
  }

  public DefaultA__Certificate(String instance_name) {
