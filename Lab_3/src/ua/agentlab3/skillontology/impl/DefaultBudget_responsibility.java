...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Skill_Ontology#Budget_responsibility
* @author OntologyBeanGenerator v4.1
* @version 2015/06/10, 23:36:36
*/
public class DefaultBudget_responsibility implements Budget_responsibility {

  private static final long serialVersionUID = -1750159446835811867L;

  private String _internalInstanceName = null;

  public DefaultBudget_responsibility() {
    this._internalInstanceName = "";
  }

  public DefaultBudget_responsibility(String instance_name) {
