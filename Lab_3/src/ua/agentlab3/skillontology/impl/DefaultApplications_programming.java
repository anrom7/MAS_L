...
/**
* Protege name: http://mccarthy.dia.fi.upm.es/Skill_Ontology#Applications_programming
* @author OntologyBeanGenerator v4.1
* @version 2015/06/10, 23:36:36
*/
public class DefaultApplications_programming implements Applications_programming {

  private static final long serialVersionUID = -1750159446835811867L;

  private String _internalInstanceName = null;

  public DefaultApplications_programming() {
    this._internalInstanceName = "";
  }

  public DefaultApplications_programming(String instance_name) {
