...
*/
public interface Language_Level extends jade.content.Concept {
   ...
   */
   ...
   public Iterator getAllIs_spoken_production_level_Language_Proficiency();
   public List getIs_spoken_production_level_Language_Proficiency();
   public void setIs_spoken_production_level_Language_Proficiency(List l);
   ...
   */
   ...
   public Iterator getAllIs_reading_level_Language_Proficiency();
   public List getIs_reading_level_Language_Proficiency();
   public void setIs_reading_level_Language_Proficiency(List l);
   ...
   */
   ...
   public Iterator getAllIs_writing_level_Language_Proficiency();
   public List getIs_writing_level_Language_Proficiency();
   public void setIs_writing_level_Language_Proficiency(List l);
   ...
   */
   ...
   public Iterator getAllIs_spoken_interaction_level_Language_Proficiency();
   public List getIs_spoken_interaction_level_Language_Proficiency();
   public void setIs_spoken_interaction_level_Language_Proficiency(List l);
   ...
   */
   ...
   public Iterator getAllIs_listening_level_Language_Proficiency();
   public List getIs_listening_level_Language_Proficiency();
   public void setIs_listening_level_Language_Proficiency(List l);
