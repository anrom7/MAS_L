	...
	protected void setup() {
		...
		addBehaviour(new ContractNetResponder(this, template) {
			...
			protected ACLMessage handleCfp(ACLMessage cfp) throws NotUnderstoodException, RefuseException {
				System.out.println("Seller "+getLocalName()+": CFP received from "+cfp.getSender().getName()+". Propose - "+cfp.getContent());
				int proposal = evaluateAction();
				if (proposal < 1000) {
					// We provide a proposal
					System.out.println("Seller "+getLocalName()+": Proposed price - "+proposal);
					...
					System.out.println("Seller "+getLocalName()+" propose too big prise (more than 1000)");
			...
			protected ACLMessage handleAcceptProposal(ACLMessage cfp, ACLMessage propose,ACLMessage accept) throws FailureException {
				...
				System.out.println("Seller "+getLocalName()+": Deal successfully performed");
